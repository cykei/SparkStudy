...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Load our input data.
        JavaRDD<String> lines = sc.textFile("C:\\Projects\\IntellJIdeaProjects\\HelloSpark\\src\\input.txt",2).toJavaRDD();

        // Check read data
        lines.collect().forEach(s -> System.out.println(s));

        // Split up into words.gg
        ...
        countsStr.saveAsTextFile("C:\\Projects\\IntellJIdeaProjects\\HelloSpark\\src\\output");
    }
}